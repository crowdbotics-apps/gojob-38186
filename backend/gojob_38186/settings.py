"""
Django settings for gojob_38186 project.
...
WSGI_APPLICATION = 'gojob_38186.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gojob_38186 API",
    "DESCRIPTION": "API documentation for gojob_38186 App",
    "VERSION": "v1",
}
